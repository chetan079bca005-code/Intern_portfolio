      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex flex-col items-center gap-1 sm:items-start">
            <span className="text-md font-semibold text-slate-200">Portfolio Website</span>
          ...
          <div className="flex gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="rounded-full p-2 text-slate-400 hover:bg-slate-900 hover:text-indigo-400 transition-all duration-200 hover:scale-110"
